; Listing generated by Microsoft (R) Optimizing Compiler Version 19.23.28106.4 
	...
	TITLE	D:\Réseau neuronnes - Projet Raven\Réseau\solution_lab_apprentissage_a_partir_bot\solution_lab_apprentissage_a_partir_bot\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG158674 DB	'invalid argument', 00H
	ORG $+3
$SG158675 DB	'%s', 00H
	ORG $+1
$SG158676 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.23.28105\include\xmemory', 00H
$SG158677 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG158678 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG158679 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG153733 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG153734 DB	'D', 00H, ':', 00H, '\', 00H, 'R', 00H, 0e9H, 00H, 's', 00H
	...
	DB	00H, 'a', 00H, 'm', 00H, 'e', 00H, '\', 00H, 'B', 00H, 'a', 00H
	DB	's', 00H, 'e', 00H, 'G', 00H, 'a', 00H, 'm', 00H, 'e', 00H, 'E'
	DB	00H, 'n', 00H, 't', 00H, 'i', 00H, 't', 00H, 'y', 00H, '.', 00H
	DB	'c', 00H, 'p', 00H, 'p', 00H, 00H, 00H
	ORG $+6
$SG153735 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\Réseau neuronnes - Projet Raven\Réseau\solution_lab_apprentissage_a_partir_bot\solution_lab_apprentissage_a_partir_bot\Common\Game\BaseGameEntity.cpp
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG153733
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG153734
	push	OFFSET $SG153735
	call	__wassert
